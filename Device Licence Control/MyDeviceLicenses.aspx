<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyDeviceLicenses.aspx.cs" Inherits="Device_Licence_Control.MyDeviceLicenses" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>My Device Licenses - Device Control</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .licenses-container { background-color: white; padding: 30px; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.1); margin-bottom: 30px; }
        .licenses-container h3 { color: #2c3e50; margin-bottom: 20px; border-bottom: 2px solid #3498db; padding-bottom: 10px; }
        .licenses-table { width: 100%; border-collapse: collapse; background-color: white; box-shadow: 0 4px 10px rgba(0,0,0,0.1); }
        .licenses-table thead { background-color: #2c3e50; color: white; }
        .licenses-table thead th { padding: 15px; text-align: left; font-weight: 600; }
        .licenses-table tbody td { padding: 15px; border-bottom: 1px solid #ecf0f1; }
        .licenses-table tbody tr:hover { background-color: #f8f9fa; }
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="header-section">
                <h2>My Device Licenses</h2>
                <p>View and monitor all device licenses assigned to your account.</p>
            </div>

            <asp:Label ID="lblMessage" runat="server" CssClass="message-box"></asp:Label>

            <div class="licenses-container">
                <h3>Your Device Licenses</h3>
                
                <asp:Panel ID="pnlLicenses" runat="server">
                    <div style="overflow-x: auto;">
                        <asp:GridView ID="gvDeviceLicenses" runat="server" AutoGenerateColumns="False" CssClass="licenses-table">
                            <Columns>
                                <asp:BoundField DataField="KeyDeviceAssignmentID" HeaderText="License ID" />
                                <asp:BoundField DataField="ActivationKeyID" HeaderText="Activation Key ID" />
                                <asp:BoundField DataField="DeviceModel" HeaderText="Device Model" />
                                <asp:BoundField DataField="DeviceName" HeaderText="Device Name" />
                                <asp:BoundField DataField="AssignmentDate" HeaderText="Assignment Date" DataFormatString="{0:yyyy-MM-dd}" />
                ...
                <asp:Panel ID="pnlEmpty" runat="server" Visible="false" CssClass="empty-state">
                    <h3>No Device Licenses Found</h3>
                    <p>You do not have any device licenses assigned yet.</p>
                </asp:Panel>
            </div>
        </div>
    </form>
