<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Packages.aspx.cs" Inherits="Device_Licence_Control.Packages" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Manage Packages - Device Control</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .packages-table { width: 100%; border-collapse: collapse; background-color: white; box-shadow: 0 4px 10px rgba(0,0,0,0.1); }
        .packages-table thead { background-color: #2c3e50; color: white; }
        .packages-table thead th { padding: 15px; text-align: left; font-weight: 600; }
        .packages-table tbody td { padding: 15px; border-bottom: 1px solid #ecf0f1; }
        .packages-table tbody tr:hover { background-color: #f8f9fa; }
        ...
        <div class="container">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    <label>Version *</label>
                    <asp:TextBox ID="txtVersion" runat="server" placeholder="Enter version (e.g., 1.0.0)"></asp:TextBox>
                </div>

                <div class="form-group">
                    <label>Package Model *</label>
                    <asp:TextBox ID="txtPackageModel" runat="server" placeholder="Enter package model description"></asp:TextBox>
                </div>

                <asp:Button ID="btnAddPackage" runat="server" Text="Add Package" CssClass="btn-add" OnClick="btnAddPackage_Click" />
            </div>
            ...
            <div class="form-section">
                ...
                <asp:Panel ID="pnlPackages" runat="server">
                    <div style="overflow-x: auto;">
                        <asp:GridView ID="gvPackages" runat="server" AutoGenerateColumns="False" OnRowCommand="gvPackages_RowCommand" CssClass="packages-table">
                            <Columns>
                                <asp:BoundField DataField="PackageID" HeaderText="Package ID" />
                                <asp:BoundField DataField="PackageModel" HeaderText="Package Model" />
                                <asp:BoundField DataField="Version" HeaderText="Version" />
                                <asp:BoundField DataField="FullName" HeaderText="Created By" />
                                <asp:TemplateField HeaderText="Actions">
                                    <ItemTemplate>
                                        <asp:Button ID="btnDelete" runat="server" CommandName="DeletePackage" CommandArgument='<%# Eval("PackageID") %>' Text="Delete" CssClass="btn-delete" OnClientClick="return confirm('Are you sure you want to delete this package?');" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
